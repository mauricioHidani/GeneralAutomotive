...
public class AdministratorConfig {
    ...
    @Bean
    public AdministratorAdapter<Administrator, UUID> administratorAdapter(AdministratorRepository repository) {
    ...
    @Bean
    public DeleteAdministrator<String> administratorDelete(AdministratorAdapter<Administrator, UUID> adapter) {
